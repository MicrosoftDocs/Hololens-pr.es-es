...
> [!NOTE]
> Este artículo es una referencia técnica para profesionales de TI y profesionales de la tecnología. Si busca instrucciones de configuración HoloLens, lea " Configuración de la HoloLens[(1.ª generación)](hololens1-start.md)" o " Configuración de la[HoloLens 2](hololens2-start.md)".

Al igual que Windows dispositivos, HoloLens siempre funciona en un contexto de usuario. Siempre hay una identidad de usuario. HoloLens trata la identidad de la misma manera que otros Windows 10 dispositivos. Este artículo es una referencia en profundidad para la identidad en HoloLens y se centra en cómo HoloLens difiere de otros Windows 10 dispositivos.
...
| --- | --- | --- |
| [Azure Active Directory](/azure/active-directory/)<sup>1</sup>  | 64 | <ul><li>Proveedor de credenciales web de Azure</li><li>Aplicación de Authenticator Azure</li><li>Biométrica (Iris) &ndash; HoloLens 2<sup>solo 2</sup> </li><li>PIN &ndash; opcional para HoloLens (1.ª generación), necesario para HoloLens 2</li><li>Contraseña</li></ul> |
| [Cuenta Microsoft (MSA)](/windows/security/identity-protection/access-control/microsoft-accounts) | 1 | <ul><li>Solo HoloLens 2 &ndash; biométrica (Iris)</li><li>PIN &ndash; opcional para HoloLens (1.ª generación), necesario para HoloLens 2</li><li>Contraseña</li></ul> |
...
HoloLens 2 admite la autenticación iris. Iris se basa en Windows Hello tecnología y se admite para su uso tanto en Azure Active Directory como en las cuentas Microsoft. Iris se implementa de la misma manera que otras tecnologías de Windows Hello y logra una seguridad biométrica de 1/100 000 000.
