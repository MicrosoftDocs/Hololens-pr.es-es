...
> [!NOTE]
> Este artículo es una referencia técnica para profesionales de TI y aficionados a la tecnología. Si está buscando instrucciones HoloLens configuración, lea " Configuración de la HoloLens[(1ª generación)](hololens1-start.md)" o " Configuración de la[HoloLens 2](hololens2-start.md)".

Al igual que Windows dispositivos, HoloLens funciona siempre en un contexto de usuario. Siempre hay una identidad de usuario. HoloLens trata la identidad casi de la misma manera que otras Windows dispositivos. Este artículo es una referencia en profundidad para la identidad en HoloLens y se centra en la diferencia entre HoloLens de otros Windows dispositivos.
...
| --- | --- | --- |
| [Azure Active Directory](/azure/active-directory/)<sup>1</sup>  | 64 | <ul><li>Proveedor de credenciales web de Azure</li><li>Aplicación de azure Authenticator</li><li>Biométrica (Iris) &ndash; HoloLens 2<sup>solo 2</sup> </li><li>Clave de seguridad FIDO2</li><li>PIN &ndash; opcional para HoloLens (1ª generación), necesario para HoloLens 2</li><li>Contraseña</li></ul> |
| [Cuenta de Microsoft (MSA)](/windows/security/identity-protection/access-control/microsoft-accounts) | 1 | <ul><li>Solo HoloLens 2 &ndash; biométrica (Iris)</li><li>PIN &ndash; opcional para HoloLens (1ª generación), necesario para HoloLens 2</li><li>Contraseña</li></ul> |
...
Hay dos maneras de configurar un nuevo usuario en el HoloLens. La manera más común es durante la HoloLens rápida (OOBE). Si usa Azure Active Directory, [otros usuarios pueden iniciar sesión después](#setting-up-multi-user-support-azure-ad-only) de la configuración Azure AD usuario. HoloLens dispositivos configurados inicialmente con una cuenta local o MSA durante la OOBE no admitirán varios usuarios. Consulte Configuración de la [HoloLens (1ª generación)](hololens1-start.md) [o HoloLens 2](hololens2-start.md).
...
Al Windows en otros dispositivos, iniciar sesión durante la instalación crea un perfil de usuario en el dispositivo. El perfil de usuario almacena aplicaciones y datos. La misma cuenta también proporciona inicio de sesión único para aplicaciones, como Edge o la Microsoft Store, mediante las API Windows Account Manager.

De forma predeterminada, como en Windows 10 dispositivos, tendrá que volver a iniciar sesión cuando HoloLens se reinicie o se reanude desde el modo de espera. Puede usar la aplicación Configuración para cambiar este comportamiento, o bien el comportamiento se puede controlar mediante la directiva de grupo.
...
Los dispositivos configurados con Azure AD no permitirán iniciar sesión en el dispositivo con una cuenta Microsoft. Todas las cuentas posteriores usadas deben Azure AD cuentas del mismo inquilino que el dispositivo. Todavía puede iniciar [sesión con una cuenta Microsoft en aplicaciones](hololens-identity.md#setting-up-multi-user-support-azure-ad-only) que la admitan (por ejemplo, Microsoft Store). Para cambiar del uso de Azure AD a cuentas Microsoft para iniciar sesión en el dispositivo, debe [volver a actualizar el dispositivo](hololens-recovery.md#clean-reflash-the-device).

> [!NOTE]
> **HoloLens (1.ª generación)** empezó a admitir varios usuarios Azure AD en la actualización de abril de [2018](/windows/mixed-reality/release-notes-april-2018) de Windows 10 como parte [de Windows Holographic for Business](hololens-upgrade-enterprise.md).
...
### <a name="is-windows-hello-for-business-supported-on-hololens-1st-gen"></a>¿Windows Hello para empresas se admite en HoloLens (1ª generación)?

Windows Hello para empresas (que admite el uso de un PIN para iniciar sesión) es compatible con HoloLens (1.ª generación). Para permitir Windows Hello inicio de sesión con el PIN de HoloLens:

1. Mdm HoloLens administrar [el dispositivo.](hololens-enroll-mdm.md)
...
HoloLens 2 admite la autenticación iris. Iris se basa en Windows Hello tecnología y se admite para su uso tanto en Azure Active Directory como en las cuentas Microsoft. Iris se implementa de la misma manera que otras Windows Hello y logra una seguridad [biométrica de 1/100 000](/windows/security/identity-protection/hello-for-business/hello-biometrics-in-enterprise#has-microsoft-set-any-device-requirements-for-windows-hello).
...
La información biométrica de Iris se almacena localmente en cada HoloLens por [Windows Hello especificaciones .](/windows/security/identity-protection/hello-for-business/hello-biometrics-in-enterprise#where-is-windows-hello-data-stored) No se comparte y está protegido por dos capas de cifrado. No es accesible para otros usuarios, incluso un administrador, porque no hay ninguna cuenta de administrador en un HoloLens.
...
Obtenga más información sobre cómo configurar la infraestructura de identidad híbrida a fondo en [la documentación de identidad híbrida de Azure](/azure/active-directory/hybrid/).
