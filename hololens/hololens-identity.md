...
> [!NOTE]
> Este artículo es una referencia técnica para profesionales de TI y aficionados a la tecnología. Si busca instrucciones de configuración de HoloLens, lea "Configuración de[HoloLens (1.ª generación)](hololens1-start.md)" o["Configuración](hololens2-start.md)del HoloLens 2".
...
| --- | --- | --- |
| [Azure Active Directory](https://docs.microsoft.com/azure/active-directory/) (requiere Azure AD Premium) | 64 | <ul><li>Proveedor de credenciales web de Azure</li><li>Aplicación Azure Authenticator</li><li>Biométrica (Iris) &ndash; HoloLens 2<sup>solo 1</sup> </li><li>PIN &ndash; opcional para HoloLens (1ª generación), necesario para HoloLens 2</li><li>Contraseña</li></ul> |
...
> [!NOTE]
> **HoloLens (1.ª generación)** comenzó a admitir varios Azure AD usuarios en el [Actualización de abril de 2018 de Windows 10](https://docs.microsoft.com/windows/mixed-reality/release-notes-april-2018) como parte [de Windows Holographic for Business](hololens-upgrade-enterprise.md).
...
- **Azure AD:** solicita autenticación de forma predeterminada y se puede configurar mediante **Configuración** para que ya no solicite la autenticación.
...
Obtenga más información sobre cómo configurar la infraestructura de identidad híbrida en la documentación [de identidad híbrida de Azure.](https://docs.microsoft.com/azure/active-directory/hybrid/)
