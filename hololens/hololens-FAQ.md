...
ms.locfileid: "126033097"
---
# <a name="holograms-and-interactions-troubleshooting"></a>Hologramas de problemas de las interacciones y los recursos
...
Para obtener sugerencias sobre cómo usar el HoloLens, vea [Ajustar ajuste.](hololens2-setup.md#adjust-fit)
...
- [Hologramas no parecen correctos o se mueven](#holograms-dont-look-right-or-are-moving-around)
...
- Asegúrese de que no haya habido ningún cambio importante en el entorno.
...
## <a name="holograms-dont-look-right-or-are-moving-around"></a>Hologramas no parecen correctos o se mueven

Si los hologramas no tienen el aspecto correcto (por ejemplo, están con vibración o vibración, o ves revisiones negras encima), prueba una de estas correcciones:
...
- Pruebe a recorrer y a mirar el entorno para que HoloLens pueda examinarlos por completo.
- Si ha colocado una gran cantidad de hologramas, intente quitar algunos.

Si sigue teniendo problemas, intente ejecutar la aplicación Calibración. Esta aplicación calibra su HoloLens solo para que le ayude a mantener los hologramas en su mejor aspecto. Para ello, vaya **a** Configuración  >  **Utilidades del**  >  **sistema**. En **Calibración,** seleccione **Abrir calibración.**
...
- Encender algunas luces. HoloLens funciona mejor en un espacio bien encendido.
...
Si HoloLens asignar o cargar el espacio, entra en modo Limitado y no podrá colocar hologramas ni ver los hologramas que ha colocado. Estos son algunos de los aspectos que se pueden probar:
...
- Asegúrese de que está conectado a una Wi-Fi virtual. Si no está conectado a Wi-Fi, HoloLens identificar y cargar un espacio conocido.
...
- Si necesita crear un nuevo espacio, conéctese a Wi-Fi y reinicie el HoloLens.
...
- Si se carga el espacio correcto y sigue teniendo problemas, es posible que el espacio esté dañado. Para corregir este problema, seleccione el espacio y, a continuación, **seleccione Quitar**. Después de quitar el espacio, HoloLens para asignar el entorno y crear un nuevo espacio.
...
Si se acerca demasiado a un holograma, desaparecerá temporalmente para restaurar el &mdash; holograma, simplemente aléjese de él. Además, si ha colocado varios hologramas juntos, algunos pueden desaparecer. Intente quitar algunos.

Hologramas también se pueden bloquear o codificar por otros hologramas o por objetos como las paredes. Si esto sucede, pruebe una de las siguientes correcciones:

- Si el holograma está inscrito en otro holograma, mueva el holograma encasado a otra ubicación. Para ello, seleccione **Ajustar** y, a continuación, pulse y mantenga presionado para colocarlo.
- Si el holograma está en una pared, seleccione Ajustar **y,** a continuación, avance hacia la pared hasta que aparezca el holograma. Pulse y mantenga presionado y, a continuación, extraiga el holograma hacia delante y fuera de la pared.
...
Si está muy cerca de una pared o si HoloLens ha examinado aún la pared, puede ver los hologramas que se encuentran en la siguiente sala. Para examinar la pared, de pie entre uno y tres metros de la pared y mirarla.

Un objeto negro o reflectante (por ejemplo, un cómodo negro o un frigorífico de acero) cerca de la pared puede causar problemas HoloLens intentar examinar la pared. Si hay este tipo de objeto, escalo el otro lado de la pared.
...
- Cuando coloque un holograma en una pared, de pie entre uno y tres metros de la pared y desándalo directamente.
...
Intente recorrer el área en la que va a colocar la aplicación para HoloLens el área desde distintos ángulos. [Limpiar el visor del dispositivo](hololens1-hardware.md#care-and-cleaning) también puede ser de ayuda.
...
1. Habilite la telemetría completa a través **de Configuración** app -> **Privacy** Diagnostics & feedback (Diagnósticos de privacidad de >)  ->  **y, en** Optional diagnostics data (Datos de diagnóstico **opcionales),** asegúrese de que el botón de alternancia esté establecido en **On (Activar).**
1. Obtenga las correcciones más recientes de escala y estabilidad de hologramas mediante la actualización a la versión Windows sistema operativo [holográfico, (20H2 o superior).](hololens-release-notes.md#windows-holographic-version-20h2) Después de actualizar, realice lo siguiente:
    1. Quite todas las Hologramas a través de **Configuración** app -> **System**  ->  **Hologramas** ->, seleccione Quitar todos los hologramas y comience con un mapa nuevo. 
    1. Cree un nuevo mapa del espacio; para ello, lleve el HoloLens y pasee por la sala y busque todas las áreas y superficies del espacio. Haga esto entre 2 y 3 minutos.
