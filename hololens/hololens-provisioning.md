...
- Configure el modo de quiosco siguiendo [nuestras instrucciones detalladas.](hololens-kiosk.md#use-a-provisioning-package-to-set-up-a-single-app-or-multi-app-kiosk)
...
- Habilitación del Modo de desarrollador
- Configure el modo de quiosco siguiendo [las instrucciones detalladas](hololens-kiosk.md#use-a-provisioning-package-to-set-up-a-single-app-or-multi-app-kiosk)).

> [!WARNING]
> Debe ejecutar el Windows de configuración en Windows 10 configurar la Azure Active Directory mediante cualquiera de los asistentes.
...
Cuando se muestra la pantalla principal de aprovisionamiento, la OOBE se cuenta como 10 segundos antes de empezar a aplicar automáticamente todos los paquetes de aprovisionamiento. Los usuarios todavía pueden confirmar o cancelar en estos 10 segundos después de comprobar los paquetes que esperaban.
...
> [!NOTE]
> Estos pasos se aplican a todos los dispositivos HoloLens 2 y HoloLens (1.ª generación) de Windows Holographic, versión 1809 y posteriores.
