...
## <a name="provisioning-package-hololens-wizard"></a>Asistente para el aprovisionamiento HoloLens paquetes
...
- Habilitación del Modo de desarrollador
- Configure el modo de pantalla completa siguiendo las [instrucciones detalladas](hololens-kiosk.md#use-a-provisioning-package-to-set-up-a-single-app-or-multi-app-kiosk)).

> [!WARNING]
> Debe ejecutar el Windows de configuración de Windows 10 para configurar Azure Active Directory inscripción mediante cualquiera de los asistentes.
...
8. Lea la advertencia de que los archivos del proyecto pueden contener información confidencial y seleccione **Aceptar.**
...
HoloLens 2 dispositivos [en Windows Holographic versión 20H2](hololens-release-notes.md#windows-holographic-version-20h2) o posterior tienen características más recientes que ayudan a simplificar y simplificar este proceso, lo que hace que sea automático. Revise las secciones siguientes:
...
6. El dispositivo le pregunta si confía en el paquete y desea aplicarlo. Confirma que el paquete es de confianza.
...
Obtenga información sobre cómo [aplicar paquetes de aprovisionamiento durante OOBE.](hololens-provisioning.md#apply-a-provisioning-package-to-hololens-during-setup)
...
Cuando aparece la pantalla principal de aprovisionamiento, la OOBE se cuenta 10 segundos antes de empezar automáticamente a aplicar todos los paquetes de aprovisionamiento. Los usuarios todavía pueden confirmar o cancelar en estos 10 segundos después de comprobar los paquetes que esperaban.
...
> [!NOTE]
> Estos pasos se aplican a todos HoloLens 2 y dispositivos HoloLens (1.ª generación) en Windows Holographic, versión 1809 y posteriores.
