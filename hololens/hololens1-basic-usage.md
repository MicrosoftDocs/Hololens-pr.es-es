...
¿Listo para entrar en el mundo de los hologramas? Esta es una información para empezar.
...
El desplazamiento por HoloLens es muy similar al uso de un smartphone. Puede usar las manos para manipular ventanas holográficas, menús y botones.  En lugar de apuntar, hacer clic o pulsar, [](hololens-cortana.md)usará la mirada, la voz y los gestos para seleccionar aplicaciones y hologramas y para moverse por HoloLens.

Cuando conozca estas interacciones básicas, moverse por HoloLens será un complemento.
...
1. Pulsación en el aire: bajar el dedo y, a continuación, elevarlo rápidamente.
   ![Animación del gesto de pulsación en el aire.](./images/hololens-air-tap.gif)

### <a name="select-a-hologram-by-using-your-voice"></a>Selección de un holograma con la voz

1. El cursor de mirada es un punto que se mueve moviendo la cabeza. Puede usarlo para dirigirse a comandos de voz con precisión.
1. Mire el holograma que desea seleccionar.
1. Para seleccionar el holograma, diga "Seleccionar".

## <a name="holograms-and-apps"></a>Hologramas y aplicaciones

Ahora es el momento de poner los gestos a prueba.

Encontrará las aplicaciones instaladas en [](holographic-home.md) la menú Inicio y hay más aplicaciones para HoloLens (primera generación) en el Microsoft Store.

Abra el **menú** Inicio y seleccione una aplicación.

El uso de aplicaciones HoloLens es un poco diferente de en un equipo: algunas aplicaciones usan una vista 2D y se parecen a otras Windows aplicaciones. Otras aplicaciones (aplicaciones inmersivas) usan una vista 3D y, al iniciarlas, se convierten en la única aplicación que ve.

Cuando coloque una ventana de aplicación o un iniciador de aplicaciones, permanecerá hasta que la quite. Puede mover o cambiar el tamaño de estos hologramas en la ambiente principal en cualquier momento.
...
- Mantenga pulsado para seleccionar la aplicación. Mueva la mano para colocar la aplicación y suba el dedo para colocarla.
...
- Seleccione **Ajustar,** haga clic y mantenga presionado el botón de clic y mueva la mano para colocar la aplicación. Suelte el clicker y, después, seleccione **Listo.**
...
Mire la aplicación y, a continuación, realice una de las siguientes acciones.

- Mire una esquina o borde de una ventana de la aplicación y mantenga pulsado. Mueva la mano para cambiar el tamaño de la aplicación y elevar el dedo cuando haya terminado.
...
- Seleccione **Ajustar**. Mire uno de los cuadrados azules en las esquinas de la aplicación, mantenga presionado el botón de clic y, a continuación, mueva la mano para cambiar el tamaño de la aplicación. Suelte el clicker y, después, seleccione **Listo.**
...
Mire la aplicación y pulse y mantenga presionadas las dos manos para seleccionarla. Gira la aplicación manteniendo una mano estable y moviendo la otra mano alrededor de ella. Cuando haya terminado, eleve ambos dedos de índice.
