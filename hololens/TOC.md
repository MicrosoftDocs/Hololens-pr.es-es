...
## [¿Qué puede hacer HoloLens 2 por usted?](hololens-commercial-features.md)
...
### [Actualización de HoloLens](hololens-update-hololens.md)
## Uso diario
...
#### [Nueva aplicación Configuración](hololens-new-settings.md)
#### [Nuevo Microsoft Edge](hololens-new-edge.md)
### Administración de aplicaciones
#### [Búsqueda, instalación y desinstalación de aplicaciones de la tienda](holographic-store-apps.md)
#### [Administración de aplicaciones personalizadas para HoloLens 2](hololens2-holographic-custom-apps.md)
...
# Implementación de HoloLens 2
## [Escenarios de implementación comunes](hololens-requirements.md)
## [Planeamiento de la implementación de HoloLens 2](hololens-core-components.md)
...
### [Privacidad y protección de datos de HoloLens 2](hololens2-privacy.md)
...
## [Dispositivo](hololens-troubleshooting.md)
## [Hologramas e interacciones](hololens-faq.md)
## [Pantalla](hololens2-display.md)
## [Implementación y dispositivos administrados](hololens2-enterprise-troubleshooting.md#)
## [Habilitar los registros de diagnóstico](hololens-diagnostic-logs.md)
## [Reinicio, restablecimiento o recuperación de HoloLens 2](hololens-recovery.md)
...
## [Información sobre Microsoft Mesh (versión preliminar)](/mesh/overview)
...
#### [Reinicio, restablecimiento o recuperación de HoloLens (1.ª generación)](hololens1-recovery.md)
### Seguridad de HoloLens (1.ª generación)
#### [Preguntas más frecuentes sobre la seguridad de HoloLens (1.ª generación)](hololens1-faq-security.yml)
#### [Cifrado de BitLocker para HoloLens (1.ª generación)](hololens1-encryption.md)
### [Problemas conocidos y soluciones alternativas para HoloLens (1.ª generación)](hololens-known-issues.md)
