...
| --- | --- | --- | --- |
|Quiosco de una sola aplicación | Cuenta Microsoft (MSA) en Azure Active Directory (Azure AD) o cuenta local |Sí |No |
...
> <sup>2</sup> Cuando habilite la aplicación Cámara, tenga en cuenta las condiciones siguientes:
