...
A partir de la compilación **20348.1411 de Insider,** hemos agregado compatibilidad beta para el seguimiento en plataformas de movimiento dinámico bajo en HoloLens 2. Después de instalar la compilación y habilitar el modo de plataforma móvil, podrá usar el HoloLens 2 en entornos inaccesibles anteriormente, como grandes naves y grandes navos de navía. Actualmente, la característica está destinada a habilitar solo estas plataformas móviles específicas. Aunque nada impide que intente usar la característica en otros entornos, la característica se centra primero en agregar compatibilidad con estos entornos.
