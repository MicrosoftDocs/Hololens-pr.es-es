...
| Característica                 | Descripción                | Usuarios de destino | Compilación introducida |
|-------------------------|----------------------------|--------------|------------------|
| Cambios de CSP en HoloLens | Nuevos CSP para para consultar datos | Administradores de TI    | 20348.1403                 |
...
1. En un dispositivo HoloLens que ejecuta una compilación de producción, vaya a Configuración **> Actualizar & Seguridad > Programa Windows Insider** y seleccione Detener **compilaciones de Insider.**
